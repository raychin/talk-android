...
public class MediumBoldTextView extends AppCompatTextView {
    ...
    public MediumBoldTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.PSPictureMediumBoldTextView,
                                                                 defStyleAttr, 0);
        mStrokeWidth = a.getFloat(R.styleable.PSPictureMediumBoldTextView_ps_stroke_Width, mStrokeWidth);
        a.recycle();
    }
