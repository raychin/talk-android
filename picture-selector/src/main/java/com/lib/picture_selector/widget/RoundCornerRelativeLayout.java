...
public class RoundCornerRelativeLayout extends RelativeLayout {
    ...
    public RoundCornerRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.PSPictureRoundCornerRelativeLayout
            , defStyleAttr, 0);
        cornerSize = a.getDimension(R.styleable.PSPictureRoundCornerRelativeLayout_ps_corners, 0);
        isTopNormal = a.getBoolean(R.styleable.PSPictureRoundCornerRelativeLayout_ps_topNormal, false);
        isBottomNormal = a.getBoolean(R.styleable.PSPictureRoundCornerRelativeLayout_ps_bottomNormal, false);
        a.recycle();
        path = new Path();
    }
