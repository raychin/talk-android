...
object BundleKeys {
    ...
    const val KEY_FORWARD_MESSAGE_IDS = "KEY_FORWARD_MESSAGE_IDS"
    const val KEY_FORWARD_MESSAGES_JSON = "KEY_FORWARD_MESSAGES_JSON"
    const val KEY_SHARED_MESSAGE_IDS = "KEY_SHARED_MESSAGE_IDS"
    const val KEY_FORWARD_SEQUENTIAL_MODE = "KEY_FORWARD_SEQUENTIAL_MODE"
    const val KEY_FORWARD_COMMENT = "KEY_FORWARD_COMMENT"
}
